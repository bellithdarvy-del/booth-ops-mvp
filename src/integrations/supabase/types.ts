  ...
  public: {
    Tables: {
      booth_session_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "booth_session_items_item_id_fkey"
            columns: ["item_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "booth_session_items_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      booth_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "booth_sessions_opened_by_fkey"
            columns: ["opened_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
      ...
      cashbook: {
        ...
        Relationships: [
          {
            foreignKeyName: "cashbook_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "booth_sessions"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "cashbook_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["user_id"]
